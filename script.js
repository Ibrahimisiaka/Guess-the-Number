...
* TODO: Console whether the guess is to high, too low, or is correct inside playGame() function
* TODO: Create a function called displayResult to move the logic for if the guess is too high, too low or correct.
* TODO: Complete the showYouwon..., showNumberAbove, showNumberBelow functions
...
/**
 * Show the result for if the guess id too high, too low, or correct
...
/**
 * Initialize a new game by resetting all values and content on
...
function showNumberAbove(){
    ...
    /**
     * Retrieve the dialog using the getdDialog() function 
     * and save it to variable called dialog
